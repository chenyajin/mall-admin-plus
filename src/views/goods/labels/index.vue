<!--
 * @Author: 陈亚金
 * @Date: 2023-12-27 17:57:38
 * @LastEditors: 陈亚金
 * @LastEditTime: 2023-12-27 17:59:35
 * @Description: 商品标签
-->
<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="标签排序" align="center" prop="sortNo" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="标签描述" prop="typeDesc">
          <el-input v-model="form.typeDesc" type="textarea" placeholder="请输入标签描述" />
        </el-form-item>
