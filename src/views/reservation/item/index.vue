<!--
 * @Author: 陈亚金
 * @Date: 2022-05-14 09:39:56
 * @LastEditors: 陈亚金
 * @LastEditTime: 2023-12-27 14:16:26
 * @Description: 预约商品列表
-->
<template>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['reservation:item:add']"
          >新增</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['reservation:item:edit']"
          >修改</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['reservation:item:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['reservation:item:export']"
          >导出</el-button
        >
      </el-col>
      <right-toolbar
    ...
    >
      ...
      >
        <template slot-scope="scope">
              ...
              v-hasPermi="['reservation:item:off']"
