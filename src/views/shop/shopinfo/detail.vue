 ...
 * @LastEditors: 陈亚金
 * @LastEditTime: 2023-12-27 17:11:47
 * @Description: 添加或修改门店对话框
-->
<template>
  <div class="app-container">
    <el-dialog :title="dialogData.title" :visible.sync="dialogData.show" width="900px" append-to-body :close-on-click-modal="false">
  ...
  methods: {
    getShopDetail () {
      ...
      getShopInfo(id).then(response => {
        ...
        this.businessHour = response.data.openTime ? [response.data.openingTime, response.data.closingTime] : []
